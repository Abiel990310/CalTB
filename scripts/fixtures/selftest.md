...
Calculus rarely writes a subscript, but this machinery is shared with PhysTB,
where `v0` and `x0` are on almost every page.
...
The same claim with its symbols declared is the real statement, and holds.
